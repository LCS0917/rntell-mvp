    ...
    <div className="min-h-screen bg-brand-warm selection:bg-brand-orange selection:text-white font-sans overflow-x-hidden">
      ...
      <main className="mx-auto max-w-[1400px] px-6 py-12 md:px-12 md:py-20 lg:px-24">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          ...
          <div className="group animate-reveal lg:col-span-4 relative rounded-[2rem] border-2 border-brand-charcoal bg-brand-mint-50 p-10 md:p-16 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_16px_0_0_oklch(0.20_0.02_40)]" style={{ animationDelay: '600ms' }}>
          ...
          <div className="group animate-reveal lg:col-span-2 flex flex-col justify-between rounded-[2rem] border-2 border-brand-charcoal bg-[#E0E7FF] p-10 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_12px_0_0_oklch(0.20_0.02_40)]" style={{ animationDelay: '750ms' }}>
            <div>
              <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-2xl border-2 border-brand-charcoal bg-white shadow-[4px_4px_0_0_oklch(0.20_0.02_40)] transition-transform duration-500">
