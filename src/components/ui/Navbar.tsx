...
export default function Navbar() {
  return (
    <nav className="sticky top-0 z-50 flex h-20 items-center justify-between border-b-2 border-brand-charcoal bg-white/80 px-6 backdrop-blur-md lg:px-12">
      {/* Logo */}
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="flex items-center gap-4 border-l-2 border-brand-charcoal/10 pl-8">
          ...
          <Link
            href="/signup"
            className="rounded-lg bg-brand-charcoal px-5 py-2 text-xs font-bold uppercase tracking-widest text-white transition-colors hover:bg-brand-orange"
          >
            Start
          </Link>
        </div>
